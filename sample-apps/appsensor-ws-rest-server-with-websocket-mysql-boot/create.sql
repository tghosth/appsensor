create table attack (id integer not null auto_increment, timestamp varchar(255), detection_point_id integer, detection_system_id integer, resource_id integer, rule_id integer, user_id integer, primary key (id));
create table attack_metadata (attack_id integer not null, metadata_id integer not null);
create table detection_point (id integer not null auto_increment, category varchar(255), guid varchar(255), label varchar(255), threshold_id integer, primary key (id));
...
create table resource (id integer not null auto_increment, location varchar(255), method varchar(255), primary key (id));
...
create table rule (id integer not null auto_increment, guid varchar(255), name varchar(255), window_id integer, primary key (id));
